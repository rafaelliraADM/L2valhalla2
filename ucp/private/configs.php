...
##                   Configurações                       ##
###########################################################
$panel_url = 'Lineage II Server'; // Digite exatamente o URL onde se encontra este painel (exemplo: www.l2server.com/ucp)
...
##                  Aquisição de Saldo                   ##
###########################################################
$coinName = 'Donator Coin'; // Nome da moeda online que representa o saldo (usada apenas no painel de usuário)
...
// Bonificação 1:
$buyCoins['bonus_count'][1] = '50'; // A partir de qual quantidade o bônus abaixo é dado?
...
$coinGame = 'Donator Coin'; // Nome da moeda donate in-game (geralmente Coin, Ticket ou Gold)
$coinID = 4358; // ID da moeda
...
$PagSeguro['email'] = 'email@hotmail.com'; // Email da conta que receberá as doações
$PagSeguro['token'] = 'BFA8781C3D224DC7812202084ECF09EF'; // Token gerado no PagSeguro
$PagSeguro['token_sandbox'] = 'DDFA38A079F8487D82C3E30F63D272DC'; // Token gerado no ambiente de testes do PagSeguro
...
$PayPal['business_email'] = 'email@hotmail.com'; // Email da conta que receberá as doações
...
// MERCADOPAGO CONFIGS:
$MercadoPago['actived'] = 0; // Opção ativa? (1 = Sim / 0 = Não)
$MercadoPago['client_id'] = '4120224883893027'; // "CLIENT_ID" presente na página https://www.mercadopago.com/mlb/account/credentials?type=basic
$MercadoPago['client_secret'] = 'BscaTWQMsPdpD28m4vJosxabz3vKs76p'; // "CLIENT_SECRET" presente na página https://www.mercadopago.com/mlb/account/credentials?type=basic
...
<b>AGÊNCIA:</b> 0000-0<br />
<b>CONTA:</b> 0.000-0<br />
<b>TITULAR:</b> NOME';
